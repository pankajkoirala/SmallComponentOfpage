...
const StickyNavBar = () => {
  ...
  return (
    <div>
      ...
      <iframe src="https://www.zeitverschiebung.net/clock-widget-iframe-v2?language=en&size=small&timezone=Asia%2FKathmandu" width="100%" height="90" frameborder="0" seamless></iframe>       <nav className={navPosition}>hello nav</nav>
